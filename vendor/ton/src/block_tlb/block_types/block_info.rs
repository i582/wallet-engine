    ...
    fn test_block_tlb_block_info_shard() -> anyhow::Result<()> {
        ...
        let expected = BlockInfo {
            ...
            master_ref: Some(ExtBlockRef {
                ...
                seqno: 47004578,
                root_hash: TonHash::from_str(
                    "B94923821E89A231F697F1434CBF428DCF999FF7E28B468D1CE155EDAD94B019",
                )?,
                file_hash: TonHash::from_str(
                    "256B239CC5B7984A4F453E0F619F34F75FF42EB50B5FF67181D1C9779E765197",
                )?,
            }),
            prev_ref: PrevBlockInfo::Regular(ExtBlockRef {
                ...
                seqno: 52111589,
                root_hash: TonHash::from_str(
                    "E05BBE4312F8B110287CCA5A928458778E5DD68F935AF3FD0051D33287EFCD6D",
                )?,
                file_hash: TonHash::from_str(
                    "A00B27433D3D2B05C9746F5C73C4C087C7921F1A867FE7ACABEBF0C6668F8D3C",
                )?,
            }),
            prev_vert_ref: None,
        };
