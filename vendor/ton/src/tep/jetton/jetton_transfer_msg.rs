...
mod tests {
    ...
    fn test_jetton_transfer_msg() -> anyhow::Result<()> {
        ...
        let exp_msg = JettonTransferMsg {
            ...
            dst: TonAddress::from_str(
                "0:7a92a3c8124a6d5126199765a0833f74db5d73d92253467062803eee117a580f",
            )?
            .to_msg_address_int()
            .into(),
            response_dst: TonAddress::from_str(
                "0:7d767309d795453a0e1a0dbbd672aa0b810f001b5013d44aadfba24f8e3d7e36",
            )?
            .to_msg_address_int()
            .into(),
            custom_payload: None,
