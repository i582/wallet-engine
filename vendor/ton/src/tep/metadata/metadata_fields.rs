...
pub static META_DESCRIPTION: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("description"));
...
pub static META_IMAGE_DATA: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("image_data"));
pub static META_DECIMALS: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("decimals"));
pub static META_URI: LazyLock<MetadataField> = LazyLock::new(|| MetadataField::new("uri"));
pub static META_CONTENT_URL: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("content_url"));
pub static META_ATTRIBUTES: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("attributes"));
pub static META_SOCIAL_LINKS: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("social_links"));
pub static META_MARKETPLACE: LazyLock<MetadataField> =
    LazyLock::new(|| MetadataField::new("marketplace"));
