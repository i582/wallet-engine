...
mod tests {
    ...
    fn test_dict_key_adapter_ton_hash() -> anyhow::Result<()> {
        ...
        assert_eq!(
            DictKeyAdapterTonHash::extract_key(&dict_key)?,
            TonHash::ZERO
        );
    ...
    fn test_dict_key_adapter_signed_key_parse_tlb() -> anyhow::Result<()> {
        ...
        let mut builder = TonCell::builder();
        TLBHashMap::<DictKeyAdapterInt<24, i32>, DictValAdapterTLB<TonCell>>::new(24)
            .write(&mut builder, &dict)?;
