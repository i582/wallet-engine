...
mod test {
    ...
    fn test_wallet_ext_msg_body_v5_order() -> anyhow::Result<()> {
        let body_signed = TonCell::from_boc_hex(
        ...
        assert_eq!(
            Msg::<TonCell>::from_cell(&body.msgs[0])?
                .info
                .as_int()
                .unwrap()
                .value
        ...
        assert_eq!(
            Msg::<TonCell>::from_cell(&body.msgs[1])?
                .info
                .as_int()
                .unwrap()
                .value
        ...
        assert_eq!(
            Msg::<TonCell>::from_cell(&body.msgs[2])?
                .info
                .as_int()
                .unwrap()
                .value
        ...
        assert_eq!(
            Msg::<TonCell>::from_cell(&body.msgs[3])?
                .info
                .as_int()
                .unwrap()
                .value
